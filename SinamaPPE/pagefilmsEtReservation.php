...
<p style=" width: 300; font-family:'Montserrat';font-size: 30px;text-align: center;  margin-top: 1%; color: white; margin-bottom: 0px;"> <?php    echo "Soyez au courant des films sortis recement et faites votre reservation";?> </p>
